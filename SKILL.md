...
summary: "Read-only access to Khalil's sales tracker (Supabase). Pull KPIs, today's calls, recent closes, search clients."
read_when:
  - User asks anything about pipeline, KPIs, today's calls, this month's performance, recent closes, a specific client, or how he's pacing vs goals
  - You're preparing a daily briefing, weekly recap, or pre-call context
permissions:
